...
import '../Screen/Sell/get_bidding_product_list.dart';
...
class Routes {
  ...
  static navigateToUserBiddingProductScreen(BuildContext context) {
    Navigator.push(
      context,
      CupertinoPageRoute(
        builder: (context) => const BiddingProductList(),
      ),
    );
  }
