...
const String appName = 'COP G';

//Your package name
const String packageName = 'copg.user';
const String iosPackage = 'copg.user';
...
// for demo panels
const String baseUrl = 'https://developmentalphawizz.com/COP/app/v1/api/';
const String imageUrl = 'https://developmentalphawizz.com/COP/';
const String jwtKey = 'https://developmentalphawizz.com/';
