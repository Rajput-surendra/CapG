                  ...
                  Padding(
                    ...
                    child: Row(
                      children: [
                        ...
                        SizedBox(width: 5,),
                        Text("SELECT BRAND",style: TextStyle(color: colors.blackTemp,fontSize: 13),),
            ...
            getNewCateBidingModel?.data == null ? Center(child: CircularProgressIndicator()) : getNewCateBidingModel!.data!.length == 0 ? Text("No Brand found!!"):    Container(
              ...
              child: GridView.builder(
                ...
                itemBuilder: (BuildContext context, int index) {
                  return InkWell(
                    onTap: (){
                      Navigator.push(context, MaterialPageRoute(builder: (context)=>ModelScreen(catID: getNewCateBidingModel!.data![index].id,)));
                    },
                    child: Padding(
                      ...
                      child: Card(
                        ...
                        child: Container(
                          ...
                          child: ClipRRect(
                              borderRadius: BorderRadius.circular(10),
                              child: Image.network("${getNewCateBidingModel!.data![index].image}",height: 30,width: 30,fit: BoxFit.fill,)),
                        ),
                      ),
                    ),
                  );
